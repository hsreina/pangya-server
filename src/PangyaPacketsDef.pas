...
type
  ...
  TCGPID = (
    ...
    CGPID_PLAYER_GUILD_CREATE                 = $0101,
    CGPID_PLAYER_GUILD_CHECK_NAME             = $0102,
    CGPID_PLAYER_GUILD_LIST                   = $0108,
    CGPID_PLAYER_GUILD_LIST_SEARCH            = $0109,
    CGPID_PLAYER_GUILD_REQUEST_JOIN           = $010C,
